...
export default function SequentialCircuitsPage() {
  return (
    <Layout title="Sequential Circuits GATE ECE Quick Notes + Flip-Flop Formulas + PYQs" description="Deep theory notes on latches, flip-flops, truth tables, excitation tables, characteristic equations, timing, and clocked storage." pageClassName="py-3 sm:py-4">
