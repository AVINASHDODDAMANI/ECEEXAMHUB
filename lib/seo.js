...
export const SITE_NAME = "ECEExamGuide";
export const SITE_LOCALE = "en_IN";
export const SITE_LANGUAGE = "en-IN";
export const SITE_ALTERNATE_NAMES = [];
const LEGACY_SITE_NAMES = ["ECE Exam Guide", "ECE Guide", "ECE Exam Guide Notes"];
...
export const DEFAULT_META_DESCRIPTION =
  "ECEExamGuide helps ECE students study Network Analysis, Digital Electronics, Analog Electronics, quick notes, PYQs, MCQs, formulas, and GATE, PSU, ESE, BEL, ISRO, DRDO, and university exam preparation.";
