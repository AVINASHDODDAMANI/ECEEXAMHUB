...
export function generateDescription({
  ...
  if (type === "subject") {
    if ((subjectName || title) === "Network Analysis") {
      return "Study Network Analysis notes for ECE with beginner-friendly circuit explanations, voltage-current concepts, KCL, KVL, formulas, roadmap, applications, GATE revision, and practice support.";
    }
