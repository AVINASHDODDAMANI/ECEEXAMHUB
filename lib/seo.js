...
export const DEFAULT_META_DESCRIPTION =
  "ECE Exam Guide helps ECE students learn concepts, revise quick notes, solve previous year papers, practice MCQs, and prepare for GATE, ESE, PSU, and university exams.";
...
const SUBJECT_SEO_ALIASES = {
  ...
  "Analog Electronics": ["Analog", "Analog Circuits", "Analog Electronics Quick Notes"],
  "Digital Electronics": ["Digital", "Digital Logic", "Digital Electronics Quick Notes"],
...
const SEO_TERM_ALIASES = {
  ...
  Notes: ["quick notes", "handwritten notes", "study notes", "revision notes", "exam quick revision notes"],
