...
const TOPIC_STUDY_LINKS = {
  "Analog Communication": [
    ...
    { label: "Communication Systems notes", href: "/subjects/communication-systems" },
  ],
  BJT: [
  ...
  "Number Systems": [
    ...
    { label: "Digital Electronics notes", href: "/subjects/digital-electronics" },
  ],
  "Root Locus": [
  ...
  Semiconductors: [
    ...
    { label: "Analog Electronics notes", href: "/subjects/analog-electronics" },
  ],
  TDMA: [
    { label: "Digital communication theory", href: "/learn/communications/digital-communication" },
    { label: "Communication Systems notes", href: "/subjects/communication-systems" },
  ...
  "Transient Response": [
    ...
    { label: "Network Analysis notes", href: "/subjects/network-analysis" },
  ],
  "Two-Port Networks": [
...
export function buildPaperPdfMarkup(paper, paperQuestions = [], options = {}) {
  ...
  const explanationUrl = `${normalizeBaseUrl(options.siteUrl)}/solution/${slugifyPaper(paper.exam, paper.year)}`;
