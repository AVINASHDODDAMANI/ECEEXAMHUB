...
import { electromagneticVisualizationData } from "../../data/electromagnetic-visualization-data";
...
import FieldLineAnimation from "./FieldLineAnimation";
import VectorFieldRenderer from "./VectorFieldRenderer";
import WavePropagationAnimation from "./WavePropagationAnimation";
...
function getAnimationComponent(visualType) {
  ...
  if (visualType === "wave") {
    return WavePropagationAnimation;
  }

  return FieldLineAnimation;
}

function ElectromagneticTheoryVisualizerComponent({ slug }) {
  const visualization = electromagneticVisualizationData[slug];
...
const ElectromagneticTheoryVisualizer = memo(ElectromagneticTheoryVisualizerComponent);

export default ElectromagneticTheoryVisualizer;
