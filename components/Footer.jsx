...
export default function Footer() {
  return (
    <footer className="mt-12 border-t border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto grid max-w-[1440px] gap-6 px-4 py-8 sm:px-6 lg:grid-cols-[minmax(0,1fr)_minmax(260px,0.55fr)_minmax(260px,0.55fr)] lg:items-start lg:px-8">
        <div>
          <BrandLogo
